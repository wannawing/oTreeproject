...
SESSION_CONFIG_DEFAULTS = dict(
    real_world_currency_per_point=0.7, participation_fee=0, doc=""
)
...
ROOMS = [
    dict(
        name='R1',
        display_name='R1',
        participant_label_file='_rooms/R1.txt',
    ),
]
...
SECRET_KEY = '9n3rb+!1z)lg1etlm$c(y^744s^t(qa6hwh9rc5bm#!zr_9ckf'

INSTALLED_APPS = ['otree']

PARTICIPANT_FIELDS = [
    'id_in_main_exp_group',
    'p2price',
    'guess_correct',
    'guess_correct2',
    'tokens',
...
# ]),
# dict(name='prosocialuncertaintypilot', display_name="Dictator Game", num_demo_participants=2,
#      app_sequence=['prosocialuncertaintypilot', 'payment_info']),
